...
def main(stdscr):
    ...
    for i, c in enumerate([c for c in myMap.distinctPositions() if c != myMap.path[0][0]]):
    ...
    message = f'The answer to part 2 is (sample should be 6, answer should be 1995): {result}\n'
    print(message)
    pass
