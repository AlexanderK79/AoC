...
for linenum, line in enumerate(data):
    ...
    for c in assignment[linenum]['instruction']:
        ...
        if c =='(':
            ...
            assignment[linenum][level]['result'] = AOCmath(assignment[linenum][level]['instruction'])
            level -= 1
    ...
    assignment[linenum]['result'] = AOCmath(assignment[linenum][level]['instruction'])
...
print (f'The answer to part {part} of day {day} is: {answer} and in test should be 26335')
